...
export function DashboardLayout() {
  ...
  return (
    <div className="dashboard-warm-bg min-h-screen md:grid md:grid-cols-[260px_1fr]">
      <aside className="dashboard-warm-panel hidden border-r border-[var(--line)] p-4 md:block">
      ...
      {open ? (
        <div className="fixed inset-0 z-40 bg-slate-900/45 md:hidden" onClick={() => setOpen(false)}>
          <aside
            className="dashboard-warm-panel h-full w-[78%] max-w-[320px] p-4"
      ...
      <div className="min-w-0">
        <header className="dashboard-warm-panel sticky top-0 z-20 flex h-16 items-center justify-between border-b border-[var(--line)] px-4 backdrop-blur md:px-6">
          <div className="flex items-center gap-2">
            <button className="rounded-lg p-2 hover:bg-[rgba(243,190,41,0.16)] md:hidden" onClick={() => setOpen(true)}>
              <Menu size={18} />
            </button>
        ...
        <div className="dashboard-warm-panel border-b border-[var(--line)] md:hidden">
              ...
              return (
                <NavLink
                  ...
                  className={`whitespace-nowrap rounded-full px-3 py-1.5 text-xs font-medium transition ${
                    active
                      ? "bg-[rgba(243,190,41,0.24)] text-[var(--accent)]"
                      : "bg-[rgba(60,42,32,0.06)] text-[var(--muted)] hover:bg-[rgba(243,190,41,0.14)]"
                  }`}
                >
                  {t(item.label)}
                </NavLink>
          ...
          return (
            <NavLink
              ...
              className={`rounded-xl px-3 py-2 transition ${
                active
                  ? "bg-[rgba(243,190,41,0.24)] text-[var(--accent)]"
                  : "text-[var(--muted)] hover:bg-[rgba(243,190,41,0.14)]"
              }`}
            >
              {t(item.label)}
            </NavLink>
