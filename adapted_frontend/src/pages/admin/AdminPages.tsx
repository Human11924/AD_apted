  ...
  return (
    <div>
      ...
      <Card>
        <DataTable
          data={[
            { id: "1", name: "Record Alpha", status: "active", updated: "2026-04-12" },
            { id: "2", name: "Record Beta", status: "active", updated: "2026-04-11" },
            { id: "3", name: "Record Gamma", status: "pending", updated: "2026-04-10" },
          ]}
          columns={[
    ...
    <div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {["Users", "Companies", "Active Groups", "Monthly Orders"].map((metric, index) => (
          <Card key={metric}>
            <p className="text-sm adapted-muted">{metric}</p>
